...
.rounded-image {
    border-radius: 50%;
    height: 48px; /* Set the height to the same value as the width */
    width: 48px;
    object-fit: cover;
}
...
@media (max-width: 767px) {
    ...
    <section class="message-area">
        <div class="container">
            ...
            <h3 style="text-align: left;">Support Chatting</h3>
            </div>
            <div class="col-6" style="margin-bottom:10px;">
    ...
    <span style="color: black; font-size: 20px; font-weight:bolder;">&nbsp;&nbsp;ElectraNerve</span>
</div>
                                        </div>
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="Open" role="tabpanel" aria-labelledby="Open-tab">
                                                    ...
                                                    <div class="chat-list">
                                                        ...
                                                        <a href="javascript()" onclick="window.location.href='mysupportadmin?id={{ $contact->id }}'" class="d-flex align-items-center">
                                                            <div class="flex-shrink-0">
                                                            @if($contact->profile_img == '')
                                    <img class="img-fluid rounded-image" src="images/profile-imgs/img-13.jpg" alt="user img">
                                    @else
                                    <img class="img-fluid rounded-image" src="images/profile-imgs/{{$contact->profile_img}}" alt="user img">
                                    @endif
                        ...
                        <div class="chatbox">
                            <div class="modal-dialog-scrollable">
                                <div class="modal-content">
                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    @if($chats[0]->customer->profile_img == '')
                                    <img class="img-fluid rounded-image" src="images/profile-imgs/img-13.jpg" alt="user img">
                                    @else
                                    <img class="img-fluid rounded-image" src="images/profile-imgs/{{$chats[0]->customer->profile_img}}" alt="user img">
                                    @endif

                                                       
                                                    </div>
                                                    <div class="flex-grow-1 ms-3">
                                                        <h3>{{$chats[0]->customer->name}}</h3>
                                                        <p>Customer</p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="send-box">
                                        <form action="sendReplyAdmin/{{$chat->customer_id}}" method="POST">
                                            @csrf
