                        ...
                        <div class="main-card">
                            <div class="row g-0">
                                ...
                                <div class="col-lg-5">
                                  ...
                                  {!! QrCode::size(100)->generate($orders->transaction_id) !!} 
                                        </div>
...
<script>
    // Function to handle printing and closing the window
    function printAndClose() {
        window.print();

        // Listen for the 'afterprint' event
        window.addEventListener('afterprint', function () {
            // Check if the print job was canceled
            if (!document.hidden) {
                // Print job was canceled, close the window
                window.close();
            }
        });

        // For modern browsers that support the 'afterprint' event
